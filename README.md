...
Cada filme na página _HTML_ possui um botão com o nome `Adicionar aos favoritos`.
...
<details>
<summary>CLIQUE AQUI PARA VER A ESTRUTURA DO OBJETO</summary>

```javascript
{
    nome: "nomeDoFilme",
    dataDeLancamento: 0000,
    notaDoFilme: 00,
}
```
</details>
...
### 6. Desenvolva testes de no mínimo 34% de cobertura total e 100% da função `fetchFilms`
...
3. Teste se, ao chamar a função `fetchFilms` sem argumento, a função `fetch` utiliza o endpoint "https://ghibliapi.herokuapp.com/films";

4. Teste se o retorno da função `fetchFilms` sem argumento é uma estrutura de dados igual ao objeto `films`, que já está importado no arquivo.


**O que será avaliado**

- Será avaliado se os testes implementados atingem no mínimo 25% da cobertura total e 100% da função `fetchFilms`.

---

### 7. Desenvolva testes de no mínimo 68% de cobertura total e 100% da função `saveFilmItems`
...
- Será avaliado se os testes implementados atingem no mínimo 75% da cobertura total e 100% da função `saveFilmItems`.

---

### 8. Desenvolva testes para atingir 100% de cobertura total e 100% da função `getSavedFilmItems`
...
- Será avaliado se os testes implementados atigem 100% da cobertura total e 100% da função `getSavedFilmItems`
